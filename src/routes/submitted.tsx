  ...
  head: () => ({
    meta: [
      { title: "Submitted — Prarambh" },
      {
        name: "description",
        content:
          "Your Prarambh entrance exam has been submitted. Results will be shared by the organisers.",
      },
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
      ...
      <p className="mt-4 max-w-md text-sm text-slate">
        Your responses have been recorded. Results will be shared by the organisers — your score is
        not shown here.
      </p>
